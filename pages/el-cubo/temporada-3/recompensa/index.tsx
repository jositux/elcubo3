              ...
              <div className={styles.columnText}>
                <div className={styles.TextContent}>
                  ...
                  <p className={styles.Description}>
                    ...
                    Falleció el 9 de julio de 1991, y tres días después de su sepelio, la bóveda en donde permanecía su
                    cuerpo explotó como si se tratara de una premonición sobre lo que sucedería con la hegemonía política
                    en el pueblo. Aunque para algunos el hecho es el inicio de una supuesta maldición que recae sobre
                    Jordán.  </p>
                </div>
              </div>
            ...
            <div className={styles.ColumnsContainer}>
              <div className={styles.columnText}>
                <div className={styles.TextContent}>
                  ...
                  <p className={styles.Description}>
                    Uno de los momentos más críticos de las sucesivas administraciones de los Ferreira fue el 23 de agosto de
                    2004 cuando el entonces alcalde, Gonzalo Bautista, recibió una llamada del gobernador de Santander para
                    informarle que una comisión haría una revisión de las cuentas y gastos del municipio por las evidentes
                    irregularidades en el manejo del presupuesto.<br /><br />
                    Al día siguiente, cuando los miembros de la comisión llegaron a Jordán, encontraron que la sede de la Alcaldía
                    había sido consumida por las llamas la noche anterior, además de los documentos que serían revisados.
                  </p>
                </div>
              </div>
              <div className={styles.columnLink}>
                  ...
                  <div className={styles.LinkItem}>
                    <a href='http://conlupa.co/oculto-canon/amula.html' target="_blank" className={styles.Link}>
                      <p className={styles.LinkText}>Oculto en el Cañón<br></br>
                        <span>Especial multimedia por Nicole Acuña y Silvia Corredor. Programa en Periodismo y Opinión Pública PO04. Escuela de Ciencias Humanas. Universidad de Rosario. 2019. Leer subapartado "Los caminos que llevan a Jordán" dentro del apartado "A mula y alpargata".: "Los caminos que llevan a Jordán"</span>
                      </p>
                      <div>
                        <RedirectionIconTimeline />
                      </div>
            ...
            <div className={`${styles.ColumnsContainer} fade_test fadeOut_test`}>
              <div className={styles.columnText}>
                <div className={styles.TextContent}>
                  ...
                  <p className={styles.Description}>
                    En el casco urbano de Jordán Sube, los estudiantes reciben clases en las instalaciones de un pequeño edificio
                    que funcionaba como ancianato. En cada salón, comparten clases tres cursos diferentes.<br /><br />
            ...
            <div className={`${styles.ColumnsContainer} fade_test fadeOut_test`}>
              <div className={styles.columnText}>
                <div className={styles.TextContent}>
                  ...
                  <p className={styles.Description}>
                    Ahora que ya conoces a todos los personajes, ¿quieres entrar en sus pensamientos más íntimos? <br /> <br /></p>
                </div>
              </div>
              <div className={styles.columnLink}>
                <div className={styles.LinksContent}>
          ...
          <div className={`${styles.EndContent} ${styles.NoHeight}`}>
            ...
            <div>
              ...
              <div className={styles.Ver360Content}>
                ...
                <p>Como recompensa puedes acceder al contenido exclusivo final y compartir el proyecto en redes. ¡Feliz
                  viaje de regreso!</p>
